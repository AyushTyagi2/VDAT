...
export default function CameraReadyGuidelines() {
  const steps = [
    ...
    },
    {
      ...
      files: [
        "Rename to: paperid_paymentproof.pdf/jpg/jpeg/png"
      ]
    },
    {
      number: 4,
      ...
      <header className="text-center text-white py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 py-16">
          ...
          <p className="text-xl max-w-3xl mx-auto font-light mb-8 leading-relaxed">
            Finalize your research paper with precision and excellence. Follow these comprehensive guidelines to ensure your work meets the highest academic standards for publication.
          </p>
          ...
          <div className="mt-8">
            <div className="group relative inline-flex items-center px-12 py-5 bg-gradient-to-r from-red-500 via-pink-500 to-purple-600 text-white font-bold text-xl rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300 uppercase tracking-wider animate-pulse">
              ...
              <AlertTriangle className="ml-3 group-hover:animate-bounce" size={24} />
      ...
      <section className="container mx-auto px-4 py-16 max-w-7xl">
        <div className="space-y-12">
          {steps.map((step, index) => (
            <div key={step.number} className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden transform hover:scale-[1.02] transition-all duration-300">
              {/* Step Header */}
              <div className={`bg-gradient-to-r ${step.color} text-white p-8 relative overflow-hidden`}>
                ...
                <div className="absolute inset-0 overflow-hidden opacity-10">
                  ...
                  <div className="absolute bottom-4 left-4">
                    <Star size={60} className="text-white animate-float delay-1000" />
                  </div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    <div className="flex items-center mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-gray-800">Requirements</h3>
                    </div>
                    <ul className="space-y-3">
                      {step.items.map((item, idx) => (
                        <li key={idx} className="flex items-start gap-3 p-3 bg-white/70 rounded-lg hover:bg-white/90 transition-all duration-200">
                  ...
                  <div>
                    <div className="flex items-center mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-gray-800">File Naming Convention</h3>
                    </div>
                    <div className="space-y-3">
                      {step.files.map((file, idx) => (
                        <div key={idx} className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-xl p-4 border-l-4 border-cyan-400 hover:border-purple-400 transition-all duration-300">
                          <code className="text-cyan-300 font-mono text-sm block break-all">{file}</code>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <ol className="max-w-4xl mx-auto bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl space-y-6 text-gray-800">
              <li className="flex items-start">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Format your paper</strong> according to Springer LNCS guidelines with all required elements.
                </p>
              </li>
              <li className="flex items-start">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Complete copyright form</strong> and ensure all blue annotated sections are filled.
                </p>
              </li>
              <li className="flex items-start">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Process payment</strong> and save proof of transaction with proper naming convention.
                </p>
              </li>
              <li className="flex items-start">
                ...
                <p className="text-lg leading-relaxed">
                  <strong>Upload all files</strong> using the designated submission portal and update softconf.
                </p>
              </li>
            </ol>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border-l-4 border-blue-500">
                ...
                <span className="text-gray-700 leading-relaxed">
                  <strong>Consult Springer's Instructions</strong> for Authors of Proceedings
                </span>
              </div>
              <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border-l-4 border-green-500">
                ...
                <span className="text-gray-700 leading-relaxed">
                  <strong>Use official templates:</strong> LaTeX in Overleaf or Word templates from author's page
                </span>
              </div>
              <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border-l-4 border-purple-500">
                ...
                <span className="text-gray-700 leading-relaxed">
                  <strong>Include ORCIDs</strong> in papers (encouraged by Springer)
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl border-l-4 border-teal-500">
                ...
                <span className="text-gray-700 leading-relaxed">
                  <strong>Corresponding author</strong> must complete and sign License-to-Publish form
                </span>
              </div>
              <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl border-l-4 border-red-500">
                ...
                <span className="text-gray-700 leading-relaxed">
                  <strong>CRITICAL:</strong> Once files are sent to Springer, authorship changes cannot be made
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Access all the tools and guidelines you need for successful submission
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="group bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-all duration-300 rounded-xl p-6 text-center hover:scale-105 transform cursor-pointer">
              ...
              <h3 className="font-bold text-white text-lg mb-2">Format Guide</h3>
            ...
            <a href="https://docs.google.com/document/d/1DaAWbwdSs1A8PVC3Hf-AMqPpDbPBcd_b/edit?tab=t.0" target="_blank" rel="noopener noreferrer">
            <div className="group bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-all duration-300 rounded-xl p-6 text-center hover:scale-105 transform cursor-pointer">
              <div className="bg-white/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-white/30 transition-all">
                <CheckCircle className="w-8 h-8 text-white group-hover:scale-110 transition-transform" />
              </div>
              <h3 className="font-bold text-white text-lg mb-2">Copyright Form</h3>
              <p className="text-white/80 text-sm">License to Publish</p>
            </div>
            </a>
            
            <a href="https://docs.google.com/forms/d/e/1FAIpQLScGlsucoDdkKw7Z0P83RAAlEEOiM3OQVnGAGEfrB1zoFTIUFA/viewform" target="_blank" rel="noopener noreferrer">
            <div className="group bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-all duration-300 rounded-xl p-6 text-center hover:scale-105 transform cursor-pointer">
              <div className="bg-white/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-white/30 transition-all">
                <Upload className="w-8 h-8 text-white group-hover:scale-110 transition-transform" />
              </div>
              <h3 className="font-bold text-white text-lg mb-2">File Upload</h3>
          ...
          <div className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 p-1 rounded-3xl inline-block animate-pulse">
            <div className="bg-white px-12 py-6 rounded-3xl">
              ...
              <p className="text-gray-600 mb-4">
                Make sure to update your camera-ready copy on the softconf portal as well
              </p>
