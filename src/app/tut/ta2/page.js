...
an inner current feedback loop. This method improves transient response and provides
inherent overcurrent protection. However, it may require additional components like current
sense resistors or transformers, and careful design. We will discuss both these techniques in
this tutorial. The current mode control has different sub-types namely CCM, DCM and BCM
control. Each of them has their own merits and demerits which will be discussed at length in
...
curve for the audience in the area of boost converter design.`,
    ...
    speakerBiographies: [
      `
Saravana Kumar is an Assistant Professor in the Microelectronics and VLSI group, Department
of Electronics and Communication Engineering (ECE), of Indian Institute of Technology (IIT)
Roorkee. He works in the area of Analog and Mixed signal integrated circuit (IC) design with
special focus on high performance and high bandwidth data converters. He received the
bachelor’s degree in Electronics and Communication Engineering from the Madras Institute
of Technology, Anna University, Chennai, in 2009, and the M. Tech degree from the Indian
Institute of Technology Delhi, New Delhi, in 2011. From 2011 to 2014, he worked as a Design
Engineer at Analog Devices, Bengaluru, India, where he worked on high-speed chip-to-chip
serial link communication. He obtained his PhD degree from the Indian Institute of Technology
Madras, Chennai, in 2021, in the area of data-converter design.`,
    ],
    basicStructure: `(Topics, Subtopics, time split-up among them with speaker name)
